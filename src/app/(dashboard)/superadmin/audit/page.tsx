...
export default function SAAudit() {
  ...
  return (<div className="space-y-4">
    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      <button className={inp} onClick={() => { setQ(""); setCat(""); setCo(""); setFrom(""); setTo(""); }}>Clear</button>
    </div>
    <div className="rounded-lg border bg-white" style={{ borderColor: "#e2e8f0" }}>
      {items.map((r: any) => (<div key={r.id} className="flex items-start gap-3 border-b px-3 py-2 last:border-0" style={{ borderColor: "#eef2f7" }}>
