...
export default function SASettings() {
  ...
  return (<div className="max-w-lg space-y-4">
    ...
    <div className="space-y-3 rounded-lg border bg-white p-4" style={{ borderColor: "#e2e8f0" }}>
      ...
      <div><div className="text-xs text-gray-500">New password</div><input className={inp} type="password" placeholder="Leave blank to keep current" value={form.password || ""} onChange={(e) => setForm({ ...form, password: e.target.value })} /></div>
