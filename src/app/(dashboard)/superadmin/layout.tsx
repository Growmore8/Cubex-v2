...
const NAV: Item[] = [
  ...
  { section: "Finance", href: "/superadmin/financials", label: "Client Financials", icon: "fa-money-bill-transfer", sub: true },
  { href: "/superadmin/billing", label: "Billing & Invoicing", icon: "fa-file-invoice-dollar", sub: true },
  ...
  { href: "/superadmin/symbols", label: "Symbols", icon: "fa-chart-bar", sub: true },
