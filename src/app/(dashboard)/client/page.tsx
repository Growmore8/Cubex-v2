    ...
    <div style={{ ...(theme === "dark" ? DARK : LIGHT), fontFamily: 'system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif' }} className="flex h-screen flex-col overflow-hidden bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          ]; return <LWChart symbol={selSym} tf={tf} theme={theme} digits={d} positions={pos} spreadPips={_spreadPips(selSym)} ind={chartInd} cfg={chartCfg} tool={chartTool} onTool={setChartTool} clearKey={chartClearKey} calcPnl={(p, price) => pnlOf(p as any, price, csz(selSym))} />; })()}</div>
        </div>
